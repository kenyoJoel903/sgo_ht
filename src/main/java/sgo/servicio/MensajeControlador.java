...
public class MensajeControlador {
	...
	@Autowired
	private MensajeDao dMensaje;

	//
	private DataSourceTransactionManager transaccion;//Gestor de la transaccion
	//urls generales
	private static final String URL_GESTION_COMPLETA="/admin/mensaje";
	private static final String URL_GESTION_RELATIVA="/mensaje";
	private static final String URL_GUARDAR_COMPLETA="/admin/mensaje/crear";
	private static final String URL_GUARDAR_RELATIVA="/mensaje/crear";
	private static final String URL_LISTAR_COMPLETA="/admin/mensaje/listar";
	private static final String URL_LISTAR_RELATIVA="/mensaje/listar";
	private static final String URL_ACTUALIZAR_COMPLETA="/admin/mensaje/actualizar";
	private static final String URL_ACTUALIZAR_RELATIVA="/mensaje/actualizar";
	private static final String URL_RECUPERAR_COMPLETA="/admin/mensaje/recuperar";
	private static final String URL_RECUPERAR_RELATIVA="/mensaje/recuperar";
	...
	public ModelAndView mostrarFormulario( Locale locale){
		...
		try {
			...
			vista.addObject("vistaJSP","mantenimiento/mensaje.jsp");
			vista.addObject("vistaJS","mantenimiento/mensaje.js");
	...
	public @ResponseBody RespuestaCompuesta recuperarRegistros(HttpServletRequest httpRequest, Locale locale){
		...
		try {
			...
			//Recuperar registros
			respuesta = dMensaje.recuperarRegistros(parametros);
	...
	public @ResponseBody RespuestaCompuesta recuperaRegistro(int ID,Locale locale){
		...
		try {			
        	...
        	respuesta= dMensaje.recuperarRegistro(ID);
	...
	public @ResponseBody RespuestaCompuesta guardarRegistro(@RequestBody Mensaje entidad,HttpServletRequest peticionHttp,Locale locale){		 
		RespuestaCompuesta respuesta = null;
		AuthenticatedUserDetails principal = null;
		...
		try {
			...
			this.transaccion = new DataSourceTransactionManager(dMensaje.getDataSource());
            ...
            respuesta= dMensaje.guardarRegistro(entidad);
	...
	public @ResponseBody RespuestaCompuesta actualizarRegistro(@RequestBody Mensaje entidad,HttpServletRequest peticionHttp,Locale locale){
		RespuestaCompuesta respuesta = null;
		AuthenticatedUserDetails principal = null;
		TransactionDefinition definicionTransaccion = null;
		TransactionStatus estadoTransaccion = null;
		...
		try {
			...
			entidad.setActualizadoPor(principal.getID()); 
			entidad.setIpActualizacion(direccionIp);
            respuesta= dMensaje.actualizarRegistro(entidad);
            if (respuesta.estado==false){          	
