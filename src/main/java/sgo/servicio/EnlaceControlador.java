...
public class EnlaceControlador {
	...
	//urls generales
	private static final String URL_GESTION_COMPLETA="/admin/enlace";
	private static final String URL_GESTION_RELATIVA="/enlace";
	private static final String URL_GUARDAR_COMPLETA="/admin/enlace/crear";
	private static final String URL_GUARDAR_RELATIVA="/enlace/crear";
	private static final String URL_LISTAR_COMPLETA="/admin/enlace/listar";
	private static final String URL_LISTAR_RELATIVA="/enlace/listar";
	private static final String URL_ACTUALIZAR_COMPLETA="/admin/enlace/actualizar";
	private static final String URL_ACTUALIZAR_RELATIVA="/enlace/actualizar";
	private static final String URL_RECUPERAR_COMPLETA="/admin/enlace/recuperar";
	private static final String URL_RECUPERAR_RELATIVA="/enlace/recuperar";
	private static final String URL_ACTUALIZAR_ESTADO_COMPLETA="/admin/enlace/actualizarEstado";
	private static final String URL_ACTUALIZAR_ESTADO_RELATIVA="/enlace/actualizarEstado";
	...
	public ModelAndView mostrarFormulario( Locale locale){
		...
		try {
			...
			vista.addObject("vistaJSP","mantenimiento/enlace.jsp");
			vista.addObject("vistaJS","mantenimiento/enlace.js");
	...
	public @ResponseBody RespuestaCompuesta recuperarRegistros(HttpServletRequest httpRequest, Locale locale){
		...
		try {
			...
			//Recuperar registros
			respuesta = dEnlace.recuperarRegistros(parametros);
	...
	public @ResponseBody RespuestaCompuesta recuperaRegistro(int ID,Locale locale){
		...
		try {			
        	...
        	respuesta= dEnlace.recuperarRegistro(ID);
	...
	public @ResponseBody RespuestaCompuesta guardarRegistro(@RequestBody Enlace entidad,HttpServletRequest peticionHttp,Locale locale){		 
		RespuestaCompuesta respuesta = null;
		AuthenticatedUserDetails principal = null;
		...
		try {
			...
			this.transaccion = new DataSourceTransactionManager(dEnlace.getDataSource());
            ...
            respuesta= dEnlace.guardarRegistro(entidad);
	...
	public @ResponseBody RespuestaCompuesta actualizarRegistro(@RequestBody Enlace entidad,HttpServletRequest peticionHttp,Locale locale){
		RespuestaCompuesta respuesta = null;
		AuthenticatedUserDetails principal = null;
		TransactionDefinition definicionTransaccion = null;
		TransactionStatus estadoTransaccion = null;
		...
		try {
			...
			entidad.setActualizadoPor(principal.getID()); 
			entidad.setIpActualizacion(direccionIp);
            respuesta= dEnlace.actualizarRegistro(entidad);
            if (respuesta.estado==false){          	
