...
public class ExchangeFaultData  implements java.io.Serializable {
    ...
    private sgo.ws.sap.comun.ExchangeLogData[] faultDetail;
    ...
    public ExchangeFaultData(
           ...
           sgo.ws.sap.comun.ExchangeLogData[] faultDetail) {
     ...
     * @return faultDetail
     */
    public sgo.ws.sap.comun.ExchangeLogData[] getFaultDetail() {
        return faultDetail;
    }
     ...
     * @param faultDetail
     */
    public void setFaultDetail(sgo.ws.sap.comun.ExchangeLogData[] faultDetail) {
        this.faultDetail = faultDetail;
    }

    public sgo.ws.sap.comun.ExchangeLogData getFaultDetail(int i) {
        return this.faultDetail[i];
    }

    public void setFaultDetail(int i, sgo.ws.sap.comun.ExchangeLogData _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:petroperu.com.pe:pmerp:pi:common", "ExchangeFaultData"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:petroperu.com.pe:pmerp:pi:common", "ExchangeLogData"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
