...
public class PermisoDao {
	...
	public static final String NOMBRE_TABLA = Constante.ESQUEMA_SEGURIDAD + "permiso";
	public static final String NOMBRE_VISTA = Constante.ESQUEMA_SEGURIDAD + "v_permiso";
	public final static String NOMBRE_CAMPO_CLAVE = "id_permiso";
	...
	public RespuestaCompuesta recuperarRegistros(ParametrosListar argumentosListar) {
		...
		Contenido<Permiso> contenido = new Contenido<Permiso>();
		List<Permiso> listaRegistros = new ArrayList<Permiso>();
		...
		try {
			...
			listaRegistros = jdbcTemplate.query(consultaSQL.toString(),parametros.toArray(), new PermisoMapper());
	...
	public RespuestaCompuesta recuperarRegistro(int ID){
			...
			try {
				...
				consultaSQL.append("=?");
				listaRegistros= jdbcTemplate.query(consultaSQL.toString(),new Object[] {ID},new PermisoMapper());
	...
	public RespuestaCompuesta guardarRegistro(Permiso permiso){
		RespuestaCompuesta respuesta = new RespuestaCompuesta();
		StringBuilder consultaSQL= new StringBuilder();
		...
		try {
			...
			listaParametros.addValue("Nombre", permiso.getNombre());
			listaParametros.addValue("Estado", permiso.getEstado());
			listaParametros.addValue("CreadoEl", permiso.getCreadoEl());
			listaParametros.addValue("CreadoPor", permiso.getCreadoPor());
			listaParametros.addValue("ActualizadoPor", permiso.getActualizadoPor());
			listaParametros.addValue("ActualizadoEl", permiso.getActualizadoEl());
			listaParametros.addValue("IpCreacion", permiso.getIpCreacion());
			listaParametros.addValue("IpActualizacion", permiso.getIpActualizacion());
	...
	public RespuestaCompuesta actualizarRegistro(Permiso permiso){
		RespuestaCompuesta respuesta = new RespuestaCompuesta();
		StringBuilder consultaSQL= new StringBuilder();
		int cantidadFilasAfectadas=0;
		try {
			...
			listaParametros.addValue("ActualizadoPor", permiso.getActualizadoPor());
			listaParametros.addValue("IpActualizacion", permiso.getIpActualizacion());
			listaParametros.addValue("Id", permiso.getId());
			SqlParameterSource namedParameters= listaParametros;
			/*Ejecuta la consulta y retorna las filas afectadas*/
	...
	public RespuestaCompuesta ActualizarEstadoRegistro(Permiso permiso) {
		RespuestaCompuesta respuesta = new RespuestaCompuesta();
		StringBuilder consultaSQL = new StringBuilder();
		int cantidadFilasAfectadas = 0;
		try {
