...
@Repository
public class ContometroDao {
	private JdbcTemplate jdbcTemplate;
	private NamedParameterJdbcTemplate namedJdbcTemplate;
	public static final String NOMBRE_TABLA = Constante.ESQUEMA_APLICACION + "contometro";
	public static final String NOMBRE_VISTA = Constante.ESQUEMA_APLICACION + "v_contometro";
	public final static String NOMBRE_CAMPO_CLAVE = "id_contometro";
	public final static String NOMBRE_CAMPO_FILTRO = "alias";
	public final static String NOMBRE_CAMPO_ORDENAMIENTO_DEFECTO = "alias";
	...
	public String mapearCampoOrdenamiento(String propiedad){
		...
		try {
			...
			if (propiedad.equals("tipoContometro")){
				campoOrdenamiento="tipo_contometro";
			}
	...
	public RespuestaCompuesta recuperarRegistros(ParametrosListar argumentosListar) {
		...
		Contenido<Contometro> contenido = new Contenido<Contometro>();
		List<Contometro> listaRegistros = new ArrayList<Contometro>();
		...
		try {
			...
			listaRegistros = jdbcTemplate.query(consultaSQL.toString(),parametros.toArray(), new ContometroMapper());
	...
	public RespuestaCompuesta recuperarRegistro(int ID){
			...
			try {
				...
				consultaSQL.append("=?");
				listaRegistros= jdbcTemplate.query(consultaSQL.toString(),new Object[] {ID},new ContometroMapper());
	...
	public RespuestaCompuesta guardarRegistro(Contometro contometro){
		RespuestaCompuesta respuesta = new RespuestaCompuesta();
		StringBuilder consultaSQL= new StringBuilder();
		...
		try {
			...
			consultaSQL.append(" (alias,estado,tipo_contometro,creado_el,creado_por,actualizado_por,actualizado_el,ip_creacion,ip_actualizacion,id_estacion) ");
			consultaSQL.append(" VALUES (:Alias,:Estado,:TipoContometro,:CreadoEl,:CreadoPor,:ActualizadoPor,:ActualizadoEl,:IpCreacion,:IpActualizacion,:IdEstacion) ");
			MapSqlParameterSource listaParametros= new MapSqlParameterSource();   
			listaParametros.addValue("Alias", contometro.getAlias());
			listaParametros.addValue("Estado", contometro.getEstado());
			listaParametros.addValue("TipoContometro", contometro.getTipoContometro());
			listaParametros.addValue("CreadoEl", contometro.getCreadoEl());
			listaParametros.addValue("CreadoPor", contometro.getCreadoPor());
			listaParametros.addValue("ActualizadoPor", contometro.getActualizadoPor());
			listaParametros.addValue("ActualizadoEl", contometro.getActualizadoEl());
			listaParametros.addValue("IpCreacion", contometro.getIpCreacion());
			listaParametros.addValue("IpActualizacion", contometro.getIpActualizacion());
			listaParametros.addValue("IdEstacion", contometro.getIdEstacion());
	...
	public RespuestaCompuesta actualizarRegistro(Contometro contometro){
		RespuestaCompuesta respuesta = new RespuestaCompuesta();
		StringBuilder consultaSQL= new StringBuilder();
		int cantidadFilasAfectadas=0;
		try {
			...
			consultaSQL.append("tipo_contometro=:TipoContometro,");
			...
			listaParametros.addValue("ActualizadoPor", contometro.getActualizadoPor());
			listaParametros.addValue("IpActualizacion", contometro.getIpActualizacion());
			listaParametros.addValue("Id", contometro.getId());
			SqlParameterSource namedParameters= listaParametros;
			/*Ejecuta la consulta y retorna las filas afectadas*/
	...
	public RespuestaCompuesta ActualizarEstadoRegistro(Contometro contometro){
		RespuestaCompuesta respuesta = new RespuestaCompuesta();
		StringBuilder consultaSQL= new StringBuilder();
		int cantidadFilasAfectadas=0;
		try {
