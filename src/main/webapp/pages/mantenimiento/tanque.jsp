...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>Tanque / <small id="tituloSeccion"><%=mapaValores.get("TITULO_LISTADO_REGISTROS")%></small></h1>
  </section>
          ...
          <div class="box-body">
            <form id="frmPrincipal" role="form">
               <div class="form-group">
                ...
                <input name="cmpDescripcion" id="cmpDescripcion" type="text" class="form-control input-sm text-uppercase" maxlength="20" required placeholder="Ingresar Descripci&oacute;n"/>
                </div>  
                <label>Volumen Total</label>
                <input name="cmpVolumenTotal" id="cmpVolumenTotal" type="text" class="form-control input-sm" maxlength="7" required placeholder="Ingrese Volumen Total" />
                </div>
                 <div class="form-group">
                <label>Volumen Trabajo</label>
                <input name="cmpVolumenTrabajo" id="cmpVolumenTrabajo" type="text" class="form-control input-sm" maxlength="7" required placeholder="Ingrese Volumen Trabajo"/>
                </div>
               <div class="form-group">
			...
			<div class="form-group">
				...
				<select tipo-control="select2" id="cmpIdProducto" name="cmpIdProducto" class="form-control input-sm" style="width: 100%">
					<option value="" selected="selected">Seleccionar</option>
				</select>
			</div>           
			<div class="form-group">
                <label>Tipo</label>
                <select tipo-control="select2" id="cmpTipo" name="cmpTipo" class="form-control input-sm text-uppercase" style="width: 100%">
                  <option value="<%=mapaValores.get("TANQUE_TIPO_VIRTUAL")%>"><%=mapaValores.get("TEXTO_TIPO_VIRTUAL")%></option>
                  <option value="<%=mapaValores.get("TANQUE_TIPO_ADMINISTRADO")%>"><%=mapaValores.get("TEXTO_TIPO_ADMINISTRADO")%></option>
                </select>
              </div>
            </form>
          </div>
    ...
    <div class="row" id="cntVistaRegistro" style="display:none;">
      <div class="col-md-12">
        <div class="box box-default">
          <div class="box-body">
            <table id="detalle_registro" class="sgo-table table table-striped" style="width:100%;"> </table>
          </div>
			<div class="box-footer">
