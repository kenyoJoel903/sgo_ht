...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>Propietarios / <small id="tituloSeccion"><%=mapaValores.get("TITULO_LISTADO_REGISTROS")%></small></h1>
  </section>
          ...
          <div class="box-body">
            <form id="frmPrincipal" role="form">
               ...
               <div class="form-group">
                ...
                <input name="cmpRuc" id="cmpRuc" type="text" class="form-control input-sm" maxlength="11"  required placeholder="Ingresar RUC"/>
                </div>
               <div class="form-group">
                <label>Tipo</label>
                <select id="cmpTipo" name="cmpTipo" class="form-control input-sm">
