...
<div class="content-wrapper">
	<section class="content-header">
    	<h1>Veh&iacute;culos / <small id="tituloSeccion"><%=mapaValores.get("TITULO_LISTADO_REGISTROS")%></small></h1>
  	</section>
					...
					<div class="box-header">
						<form id="frmBuscar" class="form-inline" role="form">
			              <div class="form-group">
			                <label for="txtFiltro" class="espaciado">Nombre Corto: </label>
          ...
          <div class="box-body">
            <form id="frmPrincipal" role="form">
               <div class="form-group">
                ...
                <input name="cmpNombreCorto" id="cmpNombreCorto" type="text" class="form-control input-sm text-uppercase" maxlength="20" required placeholder="Ingresar Nombe Corto"/>
                </div>
               <div class="form-group">
                <label>Descripci&oacute;n (Max. 80 caracteres)</label>
                <input name="cmpDescripcion" id="cmpDescripcion" type="text" class="form-control input-sm text-uppercase" maxlength="80" required placeholder="Ingresar Descripci&oacute;n"/>
                </div>                
              <div class="form-group">
                <label>Propietario</label>
                <select tipo-control="select2" id="cmpIdPropietario" name="cmpIdPropietario" class="form-control input-sm" style="width: 100%">
          ...
          <div class="box-body">
            ...
            <tbody>
             <tr>
              ...
              <tr>
                <td>Nombre Corto:</td>
                <td><span id='vistaNombreCorto'></span></td>
              </tr>              
              <tr>
              ...
              <tr>
                <td>Propietario:</td>
                <td><span id='vistaIdPropietario'></span></td>
              </tr>              
              <tr>
                <td>Estado:</td>
