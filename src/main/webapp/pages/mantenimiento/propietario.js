$(document).ready(function(){
  ...
  moduloActual.urlBase='propietario';
  ...
  moduloActual.columnasGrilla.push({ "data": 'tipo'});//Target5
  ...
  moduloActual.definicionColumnas.push({
	  ...
	  moduloActual.definicionColumnas.push({
		...
		"orderable": true,
		"visible":true,
		"render":  utilitario.formatearTipoPropietario
	});
	  moduloActual.definicionColumnas.push({
		"targets": 6,
		"orderable": true,
  ...
  moduloActual.mensajesValidacionFormulario={
	...
	cmpNombreCorto: {
		...
		maxlength: "El campo Razon Social debe contener 20 caracteres como m&aacute;ximo."
	},
	cmpRuc: {
...
/*  moduloActual.resetearFormulario= function(){
  ...
  moduloActual.llenarDetalles = function(registro){
    ...
    this.obj.vistaTipo.text(utilitario.formatearTipoPropietario(registro.tipo));
