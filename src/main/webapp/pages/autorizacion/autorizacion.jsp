	            	...
	            	<div class="col-xs-12">
						...
						<table class="sgo-simple-table table table-condensed">
			      			<thead>
			      				...
			      				<td class="celda-detalle" style="width:25%;"> <input id="cmpCodigo" name="cmpCodigo" type="password" class="form-control input-sm"/> 	</td>
			      				<td style="width:5%;"> 
			      				<td class="celda-detalle" style="width:20%;"> <label class="etiqueta-titulo-horizontal">Reingrese C&oacute;digo: </label> 					</td>
			      				<td class="celda-detalle" style="width:25%;"> <input id="cmpConfirmaCodigo" name="cmpConfirmaCodigo" type="password" class="form-control input-sm"/> </td>
			      				<td style="width:5%;"> 
			      				</tr>
