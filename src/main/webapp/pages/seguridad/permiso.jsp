...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>Permiso / <small id="tituloSeccion"><%=mapaValores.get("TITULO_LISTADO_REGISTROS")%></small></h1>
	</section>
					...
					<div class="box-header">
						<form id="frmBuscar" class="form-inline" role="form">  
			              <div class="form-group">
			                ...
			                <input id="txtFiltro" type="text" class="form-control espaciado input-sm text-uppercase"  placeholder="<%=mapaValores.get("TEXTO_BUSCAR")%>" maxlength="40">
			              </div>
			              <div class="form-group">
        ...
        <div class="box box-default">
          <div class="box-body">
            <form id="frmPrincipal" role="form">
             <div class="form-group">
                <label>Nombre</label>
                <input name="cmpNombre" id="cmpNombre" type="text" class="form-control input-sm text-uppercase" maxlength="40" required placeholder=""/>
              </div>                
              <div class="form-group">
                <label>Estado</label>
